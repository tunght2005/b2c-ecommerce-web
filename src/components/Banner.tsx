  ...
  return (
    <section className='max-w-7xl mx-auto px-4 mt-6 space-y-4'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-4 gap-4'>
        ...
        <div className='space-y-4'>
          <div className='bg-white p-4 rounded-2xl shadow'>
            ...
            <button className='mt-3 w-full bg-red-500 text-white py-2 rounded-lg'>Đăng nhập / Đăng ký</button>
          </div>
        ...
        <div className='lg:col-span-2 relative bg-white rounded-2xl overflow-hidden shadow'>
          <img src={mainBanners[current]} className='w-full h-[320px] object-cover transition' />
        ...
        <div className='grid grid-cols-1 gap-4'>
          {rightBanners.map((item, i) => (
            ...
            >
              ...
              <h3 className='text-xl font-bold mt-1'>{item.highlight}</h3>

              <p className='text-xs mt-2 opacity-80'>Áp dụng ngay hôm nay</p>

              <button className='mt-3 bg-white text-black text-xs px-3 py-1 rounded-lg font-semibold'>Xem ngay</button>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className='relative'>
        ...
        <div ref={sliderRef} className='flex gap-4 overflow-x-auto scrollbar-hide scroll-smooth px-8'>
