    ...
    <div className='bg-white rounded-3xl p-6 shadow-sm border border-gray-100 min-h-[500px]'>
      ...
      {loading ? (
        ...
        <div className='text-center py-20 flex flex-col items-center'>
          ...
          <button onClick={() => navigate('/profile/orders')} className='text-red-500 font-medium hover:underline'>
              ...
              >
                ...
                <div className='space-y-2 text-sm mb-4'>
                  <div className='flex justify-between'>
                    ...
                    <span className='font-semibold text-gray-800 font-mono'>#{orderId.slice(-6).toUpperCase()}</span>
                  </div>
                  <div className='flex justify-between'>
