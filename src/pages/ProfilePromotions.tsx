      ...
      <div className='flex items-center gap-3 mb-8'>
        ...
        <div>
          ...
          <p className='text-sm text-gray-500 mt-1'>
            Quản lý mã giảm giá và các chương trình Flash Sale bạn có thể tham gia.
          </p>
        </div>
      </div>
                        ...
                        <div className='mt-auto flex items-center justify-between'>
                          ...
                          {!isExpired && (
                            <button
                              ...
                              className='text-sm font-bold text-red-600 hover:text-red-700 hover:bg-red-50 px-3 py-1.5 rounded-lg transition-colors active:scale-95'
                            >
                              Dùng ngay
                            </button>
                          )}
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                {flashSales.map((fs) => {
                  ...
                  return (
                    <div
                      key={fs._id}
                      className='bg-white border-2 border-gray-100 rounded-2xl p-5 hover:border-yellow-400 transition-colors shadow-sm relative overflow-hidden group'
                    >
                      {/* Badge status */}
                      <div
                        className={`absolute top-0 right-0 px-3 py-1 rounded-bl-xl font-bold text-xs ${
                          isActive
                      ...
                      <div className='flex items-start gap-4 mt-2'>
                        ...
                        <div className='flex-1'>
                          ...
                          <p className='text-xs text-gray-500 mt-1 line-clamp-2'>
                            {fs.description || 'Chương trình Flash Sale đặc biệt với giá giảm sâu nhất.'}
                          </p>
                          ...
                          {!isExpired && (
                            <button
                              ...
                              className={`mt-4 w-full py-2.5 rounded-xl font-bold text-sm transition-all shadow-sm ${
                                isActive
                                  ? 'bg-gradient-to-r from-red-600 to-orange-500 text-white shadow-red-200 hover:shadow-md hover:-translate-y-0.5'
