  ...
  return (
    <div className='bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100'>
        ...
        <div className='space-y-3'>
          {addresses.map((addr) => {
            ...
            return (
              <div
                key={String(id)}
                className={`p-5 border rounded-2xl flex items-start justify-between gap-4 ${addr.is_default ? 'border-red-200 bg-red-50/30' : 'border-gray-200'}`}
              >
      ...
      {isFormOpen && (
        ...
        >
          <div
            className='bg-white rounded-3xl shadow-2xl w-full max-w-xl p-7 relative max-h-[90vh] overflow-y-auto'
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <input
                    ...
                    className='w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-red-500 focus:ring-1 focus:ring-red-500 outline-none text-sm'
                  />
                </div>
                <div>
              ...
              <div className='grid grid-cols-3 gap-3'>
                <div>
                  ...
                  <select
                    ...
                    className='w-full px-3 py-2.5 rounded-xl border border-gray-200 focus:border-red-500 outline-none bg-white text-sm'
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    className='w-full px-3 py-2.5 rounded-xl border border-gray-200 focus:border-red-500 outline-none bg-white text-sm disabled:bg-gray-100'
                  >
                    <option value=''>Chọn</option>
                    {districts.map((d) => (
