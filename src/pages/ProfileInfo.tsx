    ...
    <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100">
      ...
      <form className="max-w-2xl space-y-6" onSubmit={e => e.preventDefault()}>
        ...
        <div className="pt-6 border-t border-gray-100 flex flex-wrap gap-4 items-center">
          ...
          <button
            type="button"
            onClick={() => { setIsPwModalOpen(true); setPwError(''); setPwSuccess(false); }}
          ...
          >
            ...
            {pwSuccess ? (
              ...
              <div className="space-y-4">
                {/* Mật khẩu cũ */}
                {[
                  { label: 'Mật khẩu hiện tại', value: oldPassword, setValue: setOldPassword, show: showOld, setShow: setShowOld },
