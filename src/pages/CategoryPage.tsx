  ...
  const filteredProducts = useMemo(() => {
    const filtered = products.filter((p: any) => {
      ...
      if (name && name !== 'all') {
        ...
        if (urlName.includes('dien thoai') && (catName.includes('smartphone') || slug.includes('smartphone'))) match = true;
            ...
            <>
              ...
              {filteredProducts.length === 0 && (
                <div className='text-center py-10 sm:py-16'>
                  ...
                  <p className="text-sm text-gray-500 mt-2 max-w-sm mx-auto">Chưa có sản phẩm nào thuộc bộ lọc này trong hệ thống. Vui lòng thiết lập lại.</p>
                  <button
