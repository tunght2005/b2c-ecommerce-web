    ...
    <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 min-h-screen">
      ...
      {items.length === 0 ? (
        <div className="text-center py-20 flex flex-col items-center">
          ...
          <p className="text-gray-500 mb-6 max-w-sm">Tặng sao yêu thích để dễ dàng theo dõi các sản phẩm giảm giá và mới nhất nhé!</p>
          <Link to="/" className="text-white font-bold bg-gray-900 px-6 py-3 rounded-2xl hover:bg-black transition flex items-center gap-2">
            ...
            return (
              ...
              >
                ...
                <div className="aspect-square bg-gray-50 rounded-2xl mb-4 relative overflow-hidden flex items-center justify-center">
                  <img 
                    src={resolveImageUrl(p.thumbnail) || `https://via.placeholder.com/300x300?text=${encodeURIComponent(p.name)}`} 
                    alt={p.name} 
                ...
                <div className="flex flex-col flex-1">
                  <h3 className="font-bold text-gray-900 line-clamp-2 mb-1 group-hover:text-red-600 transition" title={p.name}>
